...
const TRESORS = [
  ...
  { sourceEthnique:'baoule',  seuilXp:400, emoji:'📿', titre:'Pendentif Akan en or',  typeObjet:'Joaillerie royale',     matiere:"Or fondu à la cire perdue",  contenu:"Akan wawɔ, srɛfuɛ, flɛ wɔ nin kɛkɛ. Ɔ yɛ famiɛn mun'yɛ.",              traduction:"Fondu selon la technique de la cire perdue héritée des Ashanti, ce bijou royal ne pouvait être porté que par les chefs.", imageUrl:P('jewellery-gold', 640, 430) },
  // DIOULA
  { sourceEthnique:'dioula',  seuilXp:0,   emoji:'⚖️', titre:'Balance de Kong',       typeObjet:'Outil de commerce',    matiere:'Laiton et cuir tanné',       contenu:"Kong tana, sɛbɛ sara, ji bɔgɔ. Warankɛla ka kɛlɛ kɛ.",                   traduction:"Kong rayonnait jusqu'au Sahara. Cette balance mesurait l'or et les noix de kola avec précision.",              imageUrl:P('jewellery-gold', 640, 430) },
  { sourceEthnique:'dioula',  seuilXp:80,  emoji:'🪬', titre:'Calebasse gravée',       typeObjet:'Récipient cérémoniel', matiere:'Cucurbitacée gravée',         contenu:"Wotoro kɛlɛn, ka sira wele. Warankɛla ɲɛ ka kɛ.",                        traduction:"Les motifs géométriques gravés racontent les routes commerciales du porteur.",                                  imageUrl:P('pottery', 640, 430) },
  { sourceEthnique:'dioula',  seuilXp:200, emoji:'👘', titre:'Grand boubou brodé',     typeObjet:'Vêtement de prestige', matiere:"Bazin riche et fil d'or",    contenu:"Boubou, ka nyi, ka ɲɛ. Warankɛla ka ɲɛ ka kɛ.",                          traduction:"Le grand boubou à broderie est le signe de la réussite du commerçant.",                                        imageUrl:P('fabric-pattern', 640, 430) },
  ...
  // SÉNOUFO
  { sourceEthnique:'senoufo', seuilXp:0,   emoji:'🦅', titre:'Sculpture Deble',        typeObjet:'Figure rituelle Poro', matiere:'Bois de rônier',              contenu:"Deble, Poro sanɔgɔ. Kpiɛmbele ka sɛ, tyeli ka sɛ.",                      traduction:"La sculpture Deble est portée lors des cérémonies du Poro. Elle représente l'ancêtre fondateur.",              imageUrl:P('wood-sculpture', 480, 480) },
  { sourceEthnique:'senoufo', seuilXp:80,  emoji:'🐦', titre:"Masque Kpeliye'e",       typeObjet:'Masque facial',        matiere:'Bois et métal',               contenu:"Kpeliye'e, tyolo sɔrɔ, pye sɔrɔ. Poro ka tyeli.",                       traduction:"Le masque Kpeliye'e guide l'âme vers les ancêtres lors des funérailles.",                                     imageUrl:P('wood-sculpture', 480, 480) },
  ...
  // BÉTÉ
  { sourceEthnique:'bete',    seuilXp:0,   emoji:'🎭', titre:'Masque Gbéa',            typeObjet:'Masque de guerre',     matiere:'Bois et fibres végétales',   contenu:"Gbéa, wlɔkɔ, wlɛɛ. Kpan nya, kpan nya di.",                             traduction:"Le masque Gbéa était porté par les guerriers Bété avant la bataille.",                                         imageUrl:P('african-mask', 480, 480) },
  ...
  { sourceEthnique:'agni',    seuilXp:200, emoji:'🏅', titre:'Médaillon pectoral',     typeObjet:'Insigne de noblesse',  matiere:'Or battu et incrusté',        contenu:"Kɔnkɔ, famiɛn mun, asɛndua. Agni ɲɔnna, sran ɔ wla.",                  traduction:"Ce médaillon en or était porté sur la poitrine par les nobles Agni lors des grandes cérémonies.",             imageUrl:P('jewellery-gold', 640, 430) },
];
