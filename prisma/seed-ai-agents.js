  ...
  const agents = [
    {
      ...
      personalite: 'Douce et patiente, Amara guide les débutants avec bienveillance. Elle répète chaque mot lentement et encourage chaque progrès.',
      voixConfig: { speed: 0.85, pitch: 1.15, voice: 'fr-FR-DeniseNeural' },
      messagesPersonnalises: {
        greeting: 'Bonjour ! Je suis Amara, votre tutrice. Écoutez ma prononciation et répétez après moi. N\'ayez pas peur de vous tromper !',
